...
@Repository
public interface  MapeoTareaLineaRepository extends JpaRepository<TareaMapeoLineaEntity, LlaveTareaMapeoLinea> {


	public  TareaMapeoLineaEntity findByLlaveTareaMapeoLinea_idCFGTareaLinea(Long idCFGTareaLinea);
