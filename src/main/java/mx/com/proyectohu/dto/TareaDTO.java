...
public class TareaDTO {
	...
	/**
	 * @return the bitacoraTareaLinea
	 */
	public List<BitacoraTareaLineaDTO> getBitacoraTareaLinea() {
		return bitacoraTareaLinea;
	}


	/**
	 * @param bitacoraTareaLinea the bitacoraTareaLinea to set
	 */
	public void setBitacoraTareaLinea(List<BitacoraTareaLineaDTO> bitacoraTareaLinea) {
		this.bitacoraTareaLinea = bitacoraTareaLinea;
	}
