...
@Entity
@Table(name="TTABCTRA_RESPUESTA_TAREA_LINEA" )
@SequenceGenerator(name = "SEQ_RESPUESTA_TAREA_LINEA_GEN",sequenceName = "SEQ_TTABCTRA_RESPUESTA_TAREA_LINEA",allocationSize = 1)
