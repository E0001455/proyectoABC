...
@Entity
@Table(name="TTABCCFG_TAREA_MAPEO_CAMPANA")
public class TareaMapeoCampanaEntity implements Serializable {


	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private LlaveTareaMapeoCampana llaveTareaMapeoCampana;
	...
	/**
	 * @return the llaveTareaMapeoCampana
	 */
	public LlaveTareaMapeoCampana getLlaveTareaMapeoCampana() {
		return llaveTareaMapeoCampana;
	}

	/**
	 * @param llaveTareaMapeoCampana the llaveTareaMapeoCampana to set
	 */
	public void setLlaveTareaMapeoCampana(LlaveTareaMapeoCampana llaveTareaMapeoCampana) {
		this.llaveTareaMapeoCampana = llaveTareaMapeoCampana;
	}
