...
public class TareaHorarioLineaEntity implements Serializable {
	
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private LlaveTareaHorarioLinea llaveTareaHorarioLinea;
	...
	public LlaveTareaHorarioLinea getLlaveTareaHorarioLinea() {
		return llaveTareaHorarioLinea;
	}

	public void setLlaveTareaHorarioLinea(LlaveTareaHorarioLinea llaveTareaHorarioLinea) {
		this.llaveTareaHorarioLinea = llaveTareaHorarioLinea;
	}
