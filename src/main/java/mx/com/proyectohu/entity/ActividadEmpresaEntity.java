...
@Entity
@Table(name="SYNONMID_TTABCCFG_ACTIVIDAD_EMPRESA" )
public class ActividadEmpresaEntity implements Serializable {
	...
	@EmbeddedId
	private LlaveActividadEmpresa llaveActividadEmpresa;
	...
	public LlaveActividadEmpresa getLlaveActividadEmpresa() {
		return llaveActividadEmpresa;
	}

	public void setLlaveActividadEmpresa(LlaveActividadEmpresa llaveActividadEmpresa) {
		this.llaveActividadEmpresa = llaveActividadEmpresa;
	}
