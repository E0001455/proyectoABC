...
@CatalogoNotacion
@Entity
@Table(name="SYNONMID_TCABCCAT_DIA")
@SequenceGenerator(name = "SEQ_DIA_GEN",sequenceName = "SYNONMID_SEQ_TCABCCAT_DIA",allocationSize = 1)
public class ABCCatDia implements Serializable,CatalogoInterface {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_DIA_GEN")
	@Column(name = "ID_DIA")
	private Long 	id;
