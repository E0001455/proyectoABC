...
public class TareaHorarioCampanaEntity implements Serializable {
	
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private LlaveTareaHorarioCampana llaveTareaHorarioCampana;
	...
	public LlaveTareaHorarioCampana getLlaveTareaHorarioCampana() {
		return llaveTareaHorarioCampana;
	}

	public void setLlaveTareaHorarioCampana(LlaveTareaHorarioCampana llaveTareaHorarioCampana) {
		this.llaveTareaHorarioCampana = llaveTareaHorarioCampana;
	}
