...
@Entity
@Table(name="TTABCCFG_TAREA_MAPEO_LINEA")
public class TareaMapeoLineaEntity implements Serializable {


	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private LlaveTareaMapeoLinea llaveTareaMapeoLinea;
	...
	/**
	 * @return the llaveTareaMapeoLinea
	 */
	public LlaveTareaMapeoLinea getLlaveTareaMapeoLinea() {
		return llaveTareaMapeoLinea;
	}

	/**
	 * @param llaveTareaMapeoLinea the llaveTareaMapeoLinea to set
	 */
	public void setLlaveTareaMapeoLinea(LlaveTareaMapeoLinea llaveTareaMapeoLinea) {
		this.llaveTareaMapeoLinea = llaveTareaMapeoLinea;
	}
