...
@CatalogoNotacion
@Entity
@Table(name="SYNONMID_TCABCCAT_COLUMNA_EMPRESA" )
@SequenceGenerator(name = "SEQ_COLUMNA_CAMPANA_GEN",sequenceName = "SYNONMID_SEQ_TCABCCAT_COLUMNA_EMPRESA",allocationSize = 1)
public class ABCCatColumnaEmpresaEntity implements Serializable,CatalogoInterface {
